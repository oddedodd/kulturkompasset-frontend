          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-700">epost@kulturkompasset.no</span>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-700">+47 123 45 678</span>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-700">Kulturveien 1, 1234 Namdal</span>
              </div>
            </div>
          </div>
